...
All of the above are documented in the module docstrings of `fsdb_rest_api.py` (the CLI) and `wsgi.py` (the WSGI entry point).
...
export PLANTDB_API_PREFIX=/api/v1      # default
