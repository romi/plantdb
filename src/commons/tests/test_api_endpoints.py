...
class TestApiPrefixComposition(unittest.TestCase):
    ...
    ENDPOINTS = [
        ...
        (api_endpoints.timelapses, (), "/api/v1/timelapses", "/plantdb/api/v1/timelapses"),
        (api_endpoints.timelapse, ("tl1",), "/api/v1/timelapses/tl1", "/plantdb/api/v1/timelapses/tl1"),
        (api_endpoints.timelapse_scans, ("tl1",), "/api/v1/timelapses/tl1/scans", "/plantdb/api/v1/timelapses/tl1/scans"),
